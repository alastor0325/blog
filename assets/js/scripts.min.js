...
!function(){"use strict";var e=document.querySelector(".post-content"),v=document.querySelector(".time-bar"),y=!0;if(e&&v){var g=e.scrollHeight,E=v.querySelector(".completed"),h=v.querySelector(".remaining"),S=v.querySelector(".time-completed"),f=v.querySelector(".time-remaining");document.addEventListener("scroll",function(){var e,t,n=window.pageYOffset||document.documentElement.scrollTop;if(v.style.bottom=n&&y?"0%":"-100%",n<=g){var r=n/g,i=(100*r).toFixed(2),o=100-parseFloat(i);E.style.width=i.toString()+"%",h.style.width=o.toString()+"%";var s=60*parseInt(v.getAttribute("data-minutes")),a=parseInt(r*s),c=parseInt(a/60),d=parseInt(60*(a/60-c)),u=s-a,l=parseInt(u/60),m=parseInt(60*(u/60-l));c=c<10?"0"+c:c,d=d<10?"0"+d:d,l=l<10?"0"+l:l,m=m<10?"0"+m:m,S.innerText=c+":"+d,f.innerText=l+":"+m,y=!0,(t=document.createEvent("CustomEvent")).initCustomEvent("stillReading"),document.dispatchEvent(t)}else{E.style.width="100%",h.style.width="0%";var p=parseInt(v.getAttribute("data-minutes"));p=p<10?"0"+p:p,S.innerText="00:00",f.innerText=p+":00",y=!1,(e=document.createEvent("CustomEvent")).initCustomEvent("finishedReading"),document.dispatchEvent(e)}})}}();
