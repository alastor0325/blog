!function(){for(var t=document.querySelectorAll("h1[id],h2[id],h3[id],h4[id],h5[id],h6[id]"),e=0;e<t.length;e++){var i=document.createElement("img");i.setAttribute("src","https://alastor0325.github.io/blog/assets/img/link-symbol.svg");var r=document.createElement("a");r.setAttribute("href","#"+t[e].getAttribute("id")),r.classList.add("anchor"),r.appendChild(i),t[e].insertBefore(r,t[e].firstChild)}}();
