!function(){for(var t=document.querySelectorAll("h1[id],h2[id],h3[id],h4[id],h5[id],h6[id]"),e=0;e<t.length;e++){var i=document.createElement("img");i.setAttribute("src","/assets/img/link-symbol.svg");var r=document.createElement("a");r.setAttribute("href","#"+t[e].getAttribute("id")),r.classList.add("anchor"),r.appendChild(i),t[e].insertBefore(r,t[e].firstChild)}}();
...
!function(){"use strict";function a(o){return o<0?0:o>1?1:o}function b(s,t,h,p){var c=h-p;return c<=0?1:a((s-t)/c)}function T(fr,at,ah,vh){var sc=ah-vh;return sc<0&&(sc=0),at+fr*sc}function Y(cx,tl,tw){return tw<=0?0:a((cx-tl)/tw)}function c(o){return o<10?"0"+o:""+o}function d(o){return c(Math.floor(o/60))+":"+c(Math.floor(o%60))}if("undefined"!=typeof module&&module.exports&&(module.exports={clamp01:a,computeProgress:b,scrollTargetForFraction:T,fractionFromX:Y,formatTime:d}),"undefined"!=typeof document){var e=document.querySelector(".post-content"),f=document.querySelector(".time-bar");if(e&&f){var g=f.querySelector(".completed"),h=f.querySelector(".remaining"),j=f.querySelector(".time-completed"),k=f.querySelector(".time-remaining"),l=60*parseInt(f.getAttribute("data-minutes"),10),m=!1,n=!1;function p(){m=!1;var s=window.pageYOffset||document.documentElement.scrollTop,r=e.getBoundingClientRect(),t=r.top+s,u=b(s,t,r.height,window.innerHeight),v=u>=1;f.style.bottom=s>0&&!v?"0%":"-100%";var w=(100*u).toFixed(2);g.style.width=w+"%",h.style.width=100-parseFloat(w)+"%";var x=Math.round(u*l);j.innerText=d(x),k.innerText=d(l-x),v&&!n?function(){var o=document.createEvent("CustomEvent");o.initCustomEvent("finishedReading"),document.dispatchEvent(o)}():v||function(){var o=document.createEvent("CustomEvent");o.initCustomEvent("stillReading"),document.dispatchEvent(o)}(),n=v}function q(){m||(m=!0,window.requestAnimationFrame(p))}document.addEventListener("scroll",q,{passive:!0}),window.addEventListener("resize",q),p();var B=f.querySelector(".bar"),z=!1;function S(fr,bh){var st=window.pageYOffset||document.documentElement.scrollTop,rc=e.getBoundingClientRect();window.scrollTo({top:T(fr,rc.top+st,rc.height,window.innerHeight),behavior:bh||"auto"})}function X(cx){var rc=B.getBoundingClientRect(),cs=window.getComputedStyle(B),pl=parseFloat(cs.paddingLeft)||0,pr=parseFloat(cs.paddingRight)||0;return Y(cx,rc.left+pl,rc.width-pl-pr)}B.addEventListener("pointerdown",function(o){z=!0,B.setPointerCapture&&B.setPointerCapture(o.pointerId),S(X(o.clientX),"smooth"),o.preventDefault()}),B.addEventListener("pointermove",function(o){z&&S(X(o.clientX),"auto")}),B.addEventListener("pointerup",function(){z=!1}),B.addEventListener("pointercancel",function(){z=!1})}}}();
